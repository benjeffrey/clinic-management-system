...
$i = 0;
$sql_app = "select * from historique order by a_id desc";
            ...
            <div class="bg-gray-800 shadow-xl h-20 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48 content-center">
                ...
                <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="./historique.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-yellow-600">
            ...
            <div id="main" class="main-content w-full flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="bg-gray-800 pt-3">
                    <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                        <h1 class="font-bold pl-2">HISTORIQUE DE TOUS LES RENDEZ-VOUS</h1>
                    </div>
                </div>
                    ...
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                                <span class="mr-3 font-semibold text-dark">liste de tous les anciens rendez-vous</span>
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <tbody>
                                    ...
                                    if($app['status']=='Okay') echo '<td class="text-green-400 px-4 py-3 whitespace-nowrap">'.$app['status'] .'</td>';
                                    else echo '<td class="text-red-400 px-4 py-3 whitespace-nowrap">'.$app['status'] .'</td>';
