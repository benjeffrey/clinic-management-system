...
if($_POST['word']!=''){
    ...
    where nom like '%$word%' or prenom like '%$word%' or specialite like '%$word%'
    order by specialite";
    // echo $sql;
    $i=0;
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <thead class="align-bottom">
                                    ...
                                    <th class="text-left pl-5 pb-3 min-w-[100px]">Prenom</th>
                                    <th class="text-left pl-5 pb-3 min-w-[100px]">Specialite</th>
                                ...
                                <tbody>
                                    ...
                                    if($total_doc == 0){
                                        ...
                                        <br>
                                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Aucun docteur ne correspond...</p>
                                        </a>
                                        </center>
                                        <br><br><br><br>
                                        </td>
