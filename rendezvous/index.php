...
$sql = "select * from appointment order by a_id desc limit 5";
...
$sql_app = "select * from appointment";
$result_app = mysqli_query($conn, $sql_app);
$total_app = mysqli_num_rows($result_app);
?>
            ...
            <div class="bg-gray-800 shadow-xl h-20 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48 content-center">
                ...
                <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="./docteurs.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-blue-500">
        ...
        <section class="w-full">
            <div id="main" class="main-content w-full flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                    ...
                    <a href="./docteurs.php" class="w-full md:w-1/2 xl:w-1/3 p-6">
                        <!--Metric Card-->
                        <div class="bg-gradient-to-b from-blue-200 to-blue-100 border-b-4 border-blue-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-blue-600"><i class="fas fa-user-md fa-2x fa-inverse"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                    ...
                    <a href="./rendezvous.php" class="w-full md:w-1/2 xl:w-1/3 p-6">
                        <!--Metric Card-->
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                <div class="flex-shrink pr-4">
                                    <div class="rounded-full p-5 bg-green-600"><i class="fas fa-list fa-2x fa-inverse"></i></div>
                                </div>
                                <div class="flex-1 text-right md:text-center">
                                    <h2 class="font-bold uppercase text-gray-600">Liste des Rendez-vous</h2>
                                   <p class="font-bold text-3xl"><?=$total_app?> <span class="text-green-500"><i class="fas fa-caret-up"></i></span></p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                                <span class="mr-3 font-semibold text-dark">liste des differents rendez-vous de l'hopital</span>
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <tbody>
                                    ...
                                    echo '<td class="px-4 py-3 whitespace-nowrap">'.$app['patient'].'</a></td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap">'.$app['tel'].'</a></td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap">Dr. '.$app['nom'].'</a></td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap">'.$app['date'] .'</a></td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap">'.$app['raison'] .'</a></td>';
