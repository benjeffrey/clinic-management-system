...
<a href="./../rendezvous/index.php" class="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block">RENDEZ-VOUS</a>
                                <a href="./../cpn/index.php" class="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block">CPN</a>                                <a href="#" class="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block">LABO</a>                            </div>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div id="main" class="main-content w-full flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="bg-gray-800 pt-3">
                    <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                        <h1 class="font-bold pl-2">Nouveau parametre de: <?=$p['nom']?></h1>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-3 mb-5">
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <!-- end card header -->
                            <!-- form -->
                            <form name="ajouter" method="POST" action="add_param.php?id2=<?=$id?>">
                            <div class="space-y-12 p-10">
                                <div class="border-b border-gray-900/10 pb-12">
                                <h2 class="text-base font-semibold leading-7 text-gray-900">Nouveau Parametre</h2>
                                <p class="mt-1 text-sm leading-6 text-gray-600">Remplir les parametre du patient <a href="patient.php?id=<?=$id?>" class="text-blue-600"><?=$p['nom']?></a> pour la journee du <?=date('d/m/y')?>.</p>
                                <?php
                                    if(isset($_SESSION['ajoute_param'])){
                                        echo $_SESSION['ajoute_param'];
                                        unset($_SESSION['ajoute_param']);
                                    }
                                ?>
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="mt-2">
                                        <input required type="text" name="TA" id="TA" autocomplete="address-level2" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        <input required type="text" name="poids" id="weight" autocomplete="address-level1" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        <input required type="text" name="pouls" id="pouls" autocomplete="pouls" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                    </div>
                                    ...
                                    <div class="mt-2 felx">
                                        <input required type="text" name="SP" id="SP" autocomplete="address-level2" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                    </div>
                                    <div class="sm:col-span-3">
                                    <label for="FR" class="block text-sm font-medium leading-6 text-gray-900">Frequence Respiratoir (rpm)</label>
                                    <div class="mt-2">
                                        <input required type="text" name="FR" id="FR" autocomplete="address-level2" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        <textarea required id="raison" name="raison" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                                    </div>
                                ...
                                <div class="inline-flex items-center justify-center w-full">
                                    ...
                                    <span class="absolute px-2 font-medium text-red-500 -translate-x-1/2 bg-white left-1/2 dark:text-white dark:bg-gray-900">FEMME ENCEINTE UNIQUEMENT</span>
                                </div>
                                <!-- end hr line -->
                                <div class="mt-3 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="sm:col-span-2 sm:col-start-1">
                                    <label for="BCF" class="block text-sm font-medium leading-6 text-gray-900">Battement de Coeur Foeutal</label>
                                    <div class="mt-2">
                                        <input type="text" name="BCF" id="BCF" autocomplete="address-level2" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="HU" id="HU" autocomplete="address-level1" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                    </div>
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="CA" id="CA" autocomplete="pouls" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                    </div>
