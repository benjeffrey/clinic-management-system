                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <tbody>
                                    ...
                                    echo '<td class="px-4 py-3 whitespace-nowrap"><a href="docteur.php?id='.$doc['id'].'">'.$doc['nom'].'</a></td>';
                                    ...
                                    echo '<td class="px-4 py-3 whitespace-nowrap"><a href="docteur.php?id='.$doc['id'].'">'.$doc['tel'] .'</a></td>';
