                    ...
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                                <span class="mr-3 font-semibold text-dark">infos sur le patient <span class="uppercase text-blue-600"><?=$p['nom']?> </span></span>
                            </h3>
                            </div>
                            ...
                            <div class="overflow-x-auto">
                                <div class="my-2 md:my-3 ml-1 align-middle text-white no-underline hover:text-white">
                            ...
                            <div class="overflow-x-auto">
                                <table class="overflow-x-auto w-full my-0 align-middle text-dark border-neutral-200">
                                <thead class="align-bottom">
                                    ...
                                    <th class="pb-3 text-left pr-12 min-w-[50px]">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    // echo '<a class="color-blue-200 px-2" href="modifier_param.php?patient='.$id.'&param='.$pa['par_id'].'"><button class="bg-blue-500 text-white font-bold py-1 px-4 rounded"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>';
                            ...
                            <!-- CPN table -->
                        <div class="overflow-x-auto">
                                <a href="ajouter_cpn.php?id=<?=$id?>" class="my-2 md:my-3 ml-1 align-middle text-white no-underline hover:text-white">
                            ...
                            <div class="overflow-x-auto w-full">
                                ...
                                <tbody>
                                    ...
                                    echo '<a class="color-blue-200 px-2" href="modifier_cpn.php?id='.$id.'&cpn='.$cpn['cpn_id'].'"><button class="bg-green-500 text-white font-bold py-1 px-4 rounded"><i class="fa fa-pencil" aria-hidden="true"></i></button></a>';
                                    echo '<a onclick="return del();" class="color-blue-200" href="delete.php?what=cpn&c='.$cpn['cpn_id'].'&patient='.$id.'"><button class="bg-red-400 text-white font-bold py-1 px-4 rounded"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>';
                                    echo '</td></tr>';
                                    } 
                                    if($total_cpn == 0){
                                        echo '<tr>
