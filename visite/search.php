...
if($_POST['word']!=''){
    ...
    where nom like '%$word%' or prenom like '%$word%' 
    order by p_id desc";
    // echo $sql;
    $i=0;
                    ...
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                                <span class="mr-3 font-semibold text-dark">liste des patients trouves</span>
                                <span class="mt-1 font-medium text-secondary-dark text-lg/normal">(<?=$t_p?>) patients trouves</span>
                            </h3>
                            </div>
                            <!-- end card header -->
                            <!-- card body  -->
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <tbody>
                                    ...
                                    if($t_p == 0){
                                        ...
                                        <br>
                                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">aucun patient ne correspond...</p>
                                        </a>
                                        </center>
                                        <br><br><br><br>
                                        </td>
