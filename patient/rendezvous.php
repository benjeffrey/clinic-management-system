...
$sql_app = "select * from appointment where pat_id = $pat_id order by a_id desc";
$result = mysqli_query($conn, $sql_app);
$total_app = mysqli_num_rows($result);
?>
                    ...
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        <li class="mr-3 flex-1">
                            <a href="./" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-blue-500">
                                <i class="fas fa-chart-area pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">ACCEUIL</span>
                            </a>
                        </li>
                        <li class="mr-3 flex-1">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="./rendezvous.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-green-600">
                                <i class="fas fa-tasks fa-inverse pr-0 md:pr-3 text-green-600"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">RENDEZ-VOUS</span>
                            </a>
                        </li>
            ...
            <div id="main" class="main-content w-full flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="bg-gray-800 pt-3">
                    <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                        <h1 class="font-bold pl-2">LISTE DE MES RENDEZ-VOUS</h1>
                    </div>
                </div>
                    ...
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                                ...
                                <span class="mt-1 font-medium text-secondary-dark text-lg/normal">liste complète (<?=$total_app?>) rendez-vous</span>
                            </h3>
                            </div>
                            <!-- end card header -->
                            <!-- card body  -->
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <thead class="align-bottom">
                                    ...
                                    <th class="text-left pl-5 pb-3 min-w-[170px]">Avec</th>
                                    <th class="text-left pl-5 pb-3 min-w-[100px]">Jour</th>
                                    <th class="text-left pl-5 pb-3 min-w-[100px]">Raison</th>
                                ...
                                <tbody>
                                    ...
                                    echo '<td class="px-4 py-3 whitespace-nowrap">Dr. '.$app['nom'].'</td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap">'.$formattedDate.'</td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap">'.$app['raison'] .'</td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap"><a onclick="return del();" class="color-blue-200" href="delete.php?what=app&id='.$app['a_id'].'"><button class="bg-red-400 text-white font-bold py-1 px-2 rounded">Annuler</button></a></td>';
