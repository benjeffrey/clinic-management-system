...
$sql_doc = "select * from docteurs order by specialite";
$result = mysqli_query($conn, $sql_doc);
$total_doc = mysqli_num_rows($result);
?>
                    ...
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="./liste_docteur.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-pink-600">
                                <i class="fas fa-tasks pr-0 md:pr-3 text-pink-600"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">LISTE DOCTEURS</span>
                            </a>
                        </li>
                        <li class="mr-3 flex-1">
            ...
            <div id="main" class="main-content w-full flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="bg-gray-800 pt-3">
                    <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                        <h1 class="font-bold pl-2">LISTE DES DOCTEURS</h1>
                    </div>
                </div>
                    ...
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                                <span class="mr-3 font-semibold text-dark">liste des Docteurs de l'hopital</span>
                                <span class="mt-1 font-medium text-secondary-dark text-lg/normal">liste complète (<?=$total_doc?>) Docteurs</span>
                            </h3>
                            </div>
                            <!-- end card header -->
                            <!-- card body  -->
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <thead class="align-bottom">
                                    ...
                                    <th class="text-left pl-5 pb-3 min-w-[100px]">Prénom</th>
                                    <th class="text-left pl-5 pb-3 min-w-[100px]">Specialité</th>
                                ...
                                <tbody>
                                    ...
                                    echo '<td class="px-4 py-3 whitespace-nowrap"><a href="docteur.php?id='.$doc['id'].'">Dr. '.$doc['nom'].'</a></td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap"><a href="docteur.php?id='.$doc['id'].'">'.$doc['prenom'].'</a></td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap"><a href="docteur.php?id='.$doc['id'].'">'.$doc['specialite'] .'</a></td>';
