...
$prenom = $_SESSION['patient2'];
$sql_patient = "select * from patient where nom = '$nom' and prenom='$prenom'";
$result_patient = mysqli_query($conn, $sql_patient);
$pat = mysqli_fetch_assoc($result_patient);
$pat_id = $pat['p_id'];


$sql = "select * from appointment where pat_id = '$pat_id' order by a_id desc limit 5";
$sql_total = "select * from appointment where pat_id = '$pat_id' order by a_id desc";
// echo $sql;
    $i=0;
                    ...
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        <li class="mr-3 flex-1">
                            <a href="./" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-blue-600">
                                <i class="fas fa-chart-area pr-0 md:pr-3 text-blue-600"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">ACCEUIL</span>
                            </a>
                        </li>
                        <li class="mr-3 flex-1">
                            <a href="./liste_docteur.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                                <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">LISTE DOCTEURS</span>
                            </a>
                        </li>
                        <li class="mr-3 flex-1">
            ...
            <div id="main" class="main-content w-full flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
                ...
                <div class="bg-gray-800 pt-3">
                    <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                        <h1 class="font-bold pl-2"><?=$nom?> <?=$prenom?></h1>
                    </div>
                </div>
                ...
                <div class="flex flex-wrap">
                            ...
                            <div class="bg-gradient-to-b from-pink-200 to-pink-100 border-b-4 border-pink-500 rounded-lg shadow-xl p-5">
                                <div class="flex flex-row items-center">
                                    ...
                                    <div class="flex-1 text-right md:text-center">
                                        <h2 class="font-bold uppercase text-gray-600">Mes rendez-vous</h2>
                    ...
                    <a href="./liste_docteur.php" class="w-full md:w-1/2 xl:w-1/3 p-6">
                        <!--Metric Card-->
                        <div class="bg-gradient-to-b from-green-200 to-green-100 border-b-4 border-green-600 rounded-lg shadow-xl p-5">
                            <div class="flex flex-row items-center">
                                ...
                                <div class="flex-1 text-right md:text-center">
                                   <p class="font-bold text-3xl">Liste Docteurs <span class="text-green-500"></span></p>
                                </div>
                            </div>
                        </div>
                        <!--/Metric Card-->
                    ...
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <h3 class="flex flex-col items-start justify-center m-2 ml-0 font-medium text-xl/tight text-dark">
                                <span class="mr-3 font-semibold text-dark">liste de mes rendez-vous</span>
                                <span class="mt-1 font-medium text-secondary-dark text-lg/normal">Petit apperçu</span>
                            </h3>
                            <div class="relative flex flex-wrap items-center my-2">
                                <a href="rendezvous.php" class="inline-block text-[.925rem] font-medium leading-normal text-center align-middle cursor-pointer rounded-2xl transition-colors duration-150 ease-in-out text-light-inverse bg-light-dark border-light shadow-none border-0 py-2 px-5 hover:bg-secondary active:bg-light focus:bg-light"> Regarder toute la liste </a>
                            </div>
                            </div>
                            <!-- end card header -->
                            <!-- card body  -->
                            ...
                            <div class="overflow-x-auto">
                                ...
                                <thead class="align-bottom">
                                    ...
                                    <th class="text-left pl-3 pb-3 min-w-[170px]">Docteur</th>
                                    <th class="text-left pl-3 pb-3 min-w-[100px]">Raison</th>
                                    <th class="text-left pl-3 pb-3 min-w-[100px]">Date</th>
                                ...
                                <tbody>
                                    ...
                                    echo '<td class="px-4 py-3 whitespace-nowrap">Dr. '.nl2br(htmlspecialchars($app['nom'])).'</td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap">'.nl2br(htmlspecialchars($app['raison'])).'</td>';
                                    echo '<td class="px-4 py-3 whitespace-nowrap">'.nl2br(htmlspecialchars($app['date'])).'</td>';
                                    echo '<td class="p-3 pr-0 text-end">
                                            <a href="rendezvous.php" class="ml-auto relative text-secondary-dark bg-light-dark hover:text-primary flex items-center h-[25px] w-[25px] text-base font-medium leading-normal text-center align-middle cursor-pointer rounded-2xl transition-colors duration-200 ease-in-out shadow-none border-0 justify-center">
