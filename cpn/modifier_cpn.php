...
$sql = "select * from patient where p_id = $id";
    ...
    $patient = $_GET['id'];
    $cpn_id = $_GET['cpn'];
    $sql_cpn = "select * from cpn where cpn_id = $cpn_id";
    $result_cpn = mysqli_query($conn, $sql_cpn);
    $c = mysqli_fetch_assoc($result_cpn);
                ...
                <div class="flex flex-wrap -mx-3 mb-5">
                    <div class="w-full max-w-full px-3 mb-6  mx-auto">
                        ...
                        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30">
                            ...
                            <!-- end card header -->
                            <!-- form -->
                            <form name="modifier" method="POST" action="add_cpn.php?patient=<?=$patient?>&id=<?=$cpn_id?>">
                            <div class="space-y-12 p-10">
                                ...
                                <?php
                                    if(isset($_SESSION['modifier_cpn'])){
                                        echo $_SESSION['modifier_cpn'];
                                        unset($_SESSION['modifier_cpn']);
                                    }
                                ?>
                                ...
                                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    ...
                                    <div class="mt-2">
                                        <textarea required id="EG" name="EG" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['EG']?></textarea>
                                    </div>
                                ...
                                <div class="mt-1 grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="conj" name="conj" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['conj']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="ES" name="ES" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['ES']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="abdomen" name="abdomen" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['abdomen']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="HU" name="HU" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['HU']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="CA" name="CA" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['CA']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="MAF" name="MAF" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['MAF']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="BDCF" name="BDCF" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['BDCF']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="plaintes" name="plaintes" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['plaintes']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="TV" name="TV" rows="4" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['TV']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <select name="oedem" id="small" class="w-1/2 ml-auto mr-auto p-2 mb-6 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        ...
                                        <option <?php if($c['oedem']=='oui') echo'selected'; else echo'';?> value="oui">OUI</option>
                                        <option <?php if($c['oedem']=='non') echo'selected'; else echo'';?> value="non">NON</option>
                                    </select>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="RE" name="RE" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['RE']?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-span-full">
                                        ...
                                        <div class="mt-2">
                                            <textarea required id="conc" name="conc" rows="3" class="block w-full rounded-md border-0 px-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?=$c['conclusion']?></textarea>
                                        </div>
                                    </div>
